...
query_hist_mysql39 <- "SELECT MODULE, TRANSDATE, DATE_FORMAT(LAST_UPDATE, '%H') HOURLY, SUM(BUNDLE_PRICE) TOTAL FROM CDR WHERE TRANSDATE = CURDATE()-7 AND STATUS_REASON = 'BUNDLE_SUCCESS' AND MODULE LIKE '%WAUU%'
